...
# O que ele resumiu no vídeo é: Se for uma lista que vai ser alterada, utilize listas(arrays), se for algo fixo, que vai ser mantido, use Tuples.  A tuple gasta menos 
